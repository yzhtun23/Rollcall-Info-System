...
<head>
	...
	<title>Rollcall Information System</title>
	...
	<link href="./css/paper-bootstrap.css" rel="stylesheet" type="text/css">
	...
	<header class="header" id="header"><!--header-start-->
		<div class="container">
			<figure class="logo animated fadeInDown delay-05s">
				<a href="#"><img src="img/rcis_logo_2.png" alt=""></a>
			</figure>
			<h1 class="animated fadeInDown delay-07s" style="color:#000;">Rollcall Information System</h1>
			<form:form action="searchRC.do" class="we-create animated fadeInUp delay-1s" method="post" commandName="rollcall">
				<div class="form-group col-lg-4 col-lg-offset-4">
					<div class="form-group">
						<form:label path="rollno" style="color:#E02121;">Enter Your Roll No.</form:label>
						<form:input path="rollno" type="text" class="form-control" name="rollno" id="rollno" placeholder="Eg. 5SE-01" data-rule="minlen:5" data-msg="Please enter the Roll No" />
						<div class="validation"></div>
					</div>
					<br>
					<input style="background-color:#E02121;" type="submit" class="btn btn-primary animated fadeInUp delay-01s" id="search_btn" value="SEARCH">
				</div>
			</form:form>
		</div>
	</header><!--header-end-->
